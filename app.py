...
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///jogo.db' # Configura a URI do banco de dados SQLite
...
app.register_blueprint(jogo_routes) # Registra o blueprint das rotas de carro na aplicação Flask
